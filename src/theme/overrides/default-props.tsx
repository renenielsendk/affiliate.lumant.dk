...
export function defaultProps(theme: Theme) {
  return {
    MuiAlert: {
      defaultProps: {
        iconMapping: {
          error: <IconifyIcon icon='solar:danger-bold' fontSize={24} />,
          info: <IconifyIcon icon='eva:info-fill' fontSize={24} />,
          success: <IconifyIcon icon='eva:checkmark-circle-2-fill' fontSize={24} />,
          warning: <IconifyIcon icon='eva:alert-triangle-fill' fontSize={24} />,
        },
      },
    },
    MuiStack: {
    ...
    MuiChip: {
      defaultProps: {
        deleteIcon: <IconifyIcon icon='solar:close-circle-bold' />,
      },
    },
    MuiDialogActions: {
      defaultProps: {
      ...
      defaultProps: {
        slots: {
          ...
          columnSortedAscendingIcon: () => (
            <IconifyIcon fontSize={20} icon='solar:alt-arrow-up-bold-duotone' sx={{ color: 'text.primary' }} />
          ),
          columnSortedDescendingIcon: () => (
            <IconifyIcon fontSize={20} icon='solar:alt-arrow-down-bold-duotone' sx={{ color: 'text.primary' }} />
          ),
          columnUnsortedIcon: () => (
            <IconifyIcon fontSize={20} icon='solar:alt-arrow-up-bold-duotone' sx={{ color: 'text.disabled' }} />
          ),
          columnMenuIcon: () => <IconifyIcon fontSize={20} icon='mingcute:more-1-fill' />,
          columnMenuSortAscendingIcon: () => <IconifyIcon fontSize={20} icon='solar:alt-arrow-up-bold-duotone' />,
          columnMenuSortDescendingIcon: () => <IconifyIcon fontSize={20} icon='solar:alt-arrow-down-bold-duotone' />,
          columnMenuFilterIcon: () => <IconifyIcon fontSize={20} icon='solar:filter-bold' />,
          columnMenuHideIcon: () => <IconifyIcon fontSize={20} icon='solar:eye-closed-bold' />,
          columnMenuManageColumnsIcon: () => <IconifyIcon fontSize={20} icon='solar:eye-bold' />,
          columnSelectorIcon: () => <IconifyIcon fontSize={20} icon='solar:eye-bold' />,
          // filter
          filterPanelDeleteIcon: () => <IconifyIcon fontSize={20} icon='eva:close-fill' />,
          openFilterButtonIcon: () => <IconifyIcon fontSize={20} icon='solar:filter-bold' />,
          columnFilteredIcon: () => <IconifyIcon width={16} icon='solar:filter-bold' sx={{ color: 'text.primary' }} />,
          // density
          densityCompactIcon: () => <IconifyIcon fontSize={20} icon='material-symbols:table-rows-narrow-rounded' />,
          densityStandardIcon: () => <IconifyIcon fontSize={20} icon='mingcute:rows-4-fill' />,
          densityComfortableIcon: () => <IconifyIcon fontSize={20} icon='mingcute:rows-2-fill' />,
          // export
          exportIcon: () => <IconifyIcon fontSize={20} icon='solar:export-bold' />,
          // quick filter
          quickFilterIcon: () => <IconifyIcon fontSize={24} icon='eva:search-fill' sx={{ color: 'text.secondary' }} />,
          quickFilterClearIcon: () => <IconifyIcon fontSize={20} icon='eva:close-fill' />,
        },
        slotProps: {
          basePopper: {
